Feature: Demo Nopcommerce's top menu acceptance criteria
  ...
  Scenario: Verify that user can see 'Name: A to Z' selection is present in 'Sort by' filter
    Given User is on Books Category page
    When User is ob Books Category page
    And   Click on 'Sort by' Filter
    And   Check that 'Name: A to Z' selection is present
    Then   'Name: A to Z' selection is present in 'Sort by' filter

  Scenario: Verify that user can see 'Name: A to Z' is filter option in 'Sort by' filter
    Given User is Son Books Category page
    When  User is on Books Category page
    And   Click on 'Sort by' Filter
